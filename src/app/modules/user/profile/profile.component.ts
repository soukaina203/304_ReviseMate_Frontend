 ...
 export class ProfileComponent {
     ...
     createForm() {
         this.myForm = this.fb.group({
             id: [this.user.id],
             nom: [this.user.lastName, [Validators.required, Validators.minLength(3), Validators.pattern('^[a-zA-Z ]+$')]],
             prenom: [this.user.firstName, [Validators.required, Validators.minLength(3), Validators.pattern('^[a-zA-Z ]+$')]],
